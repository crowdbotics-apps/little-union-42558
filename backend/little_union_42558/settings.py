"""
Django settings for little_union_42558 project.
...
ROOT_URLCONF = 'little_union_42558.urls'
...
WSGI_APPLICATION = 'little_union_42558.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_union_42558 API",
    "DESCRIPTION": "API documentation for little_union_42558 App",
    "VERSION": "v1",
}
